...
|--------------------------------------------------------------------------
|
| These routes serve public pages and authenticated non-admin workflows.
|
*/
...
// Secure order and download page (guest, token-gated)
...
Route::view('/contact', 'frontend.v1.pages.contact')->name('contact_us');

Route::get('/about-us', [HomeController::class, 'aboutUs'])->name('about_us');
Route::view('/faq', 'frontend.v1.pages.faq')->name('faq');
...
Route::get('/how-to-upload-photos', [PhotographerController::class, 'howToUploadPhotos'])->name('how-to-upload-photos');
