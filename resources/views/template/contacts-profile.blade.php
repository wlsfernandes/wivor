        ...
        <div class="card h-100">
            <div class="card-body">
                <div class="text-center">
                    ...
                    <div>
                        <img src="{{ asset('/assets/images/users/avatar-4.jpg') }}" alt="" class="avatar-lg rounded-circle img-thumbnail">
                    </div>
                        ...
                        <div data-simplebar style="max-height: 430px;">
                            <div class="d-flex align-items-start border-bottom py-4">
                                <div class="flex-shrink-0 me-2">
                                    <img class="rounded-circle avatar-xs" src="{{asset('assets/images/users/avatar-3.jpg')}}" alt="avatar-3 images">
                                </div>
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex align-items-start mt-4">
                                        <div class="flex-shrink-0 me-2">
                                            <img class="rounded-circle avatar-xs" src="{{asset('assets/images/users/avatar-4.jpg')}}" alt="avatar-4 images">
                                        </div>
                            ...
                            <div class="d-flex align-items-start border-bottom py-4">
                                <div class="flex-shrink-0 me-2">
                                    <img class="rounded-circle avatar-xs" src="{{asset('assets/images/users/avatar-5.jpg')}}" alt="avatar-5 images">
                                </div>
                            ...
                            <div class="d-flex align-items-start border-bottom py-4">
                                <div class="flex-shrink-0 me-2">
                                    <img class="rounded-circle avatar-xs" src="{{asset('assets/images/users/avatar-7.jpg')}}" alt="avatar-7 images">
                                </div>
