        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block language-switch">
                <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    @case('br')
                    <img src="{{ asset('/assets/images/flags/brazil.jpg')}}" alt="Header Language" height="16"> <span class="align-middle"></span>
                    @break
                    @case('es')
                    <img src="{{ asset('/assets/images/flags/spain.jpg')}}" alt="Header Language" height="16"> <span class="align-middle"></span>
                    @break
                    @default
                    <img src="{{ asset('/assets/images/flags/us.jpg')}}" alt="Header Language" height="16"> <span class="align-middle"></span>
                    @endswitch
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a href="{{ url('index/en') }}" class="dropdown-item notify-item">
                     ...
                     <a href="{{ url('index/br') }}" class="dropdown-item notify-item">
                        <img src="{{ asset('assets/images/flags/brazil.jpg')}}" alt="user-image" class="me-1" height="12"> <span class="align-middle">Português</span>
                    </a>
         ...
         <!--   <div class="dropdown d-inline-block">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <span class="d-none d-xl-inline-block ms-1 fw-medium font-size-15">{{ Str::ucfirst(optional(Auth::user())->name) }}</span>
