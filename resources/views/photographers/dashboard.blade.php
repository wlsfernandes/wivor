    ...
    <div class="container-fluid">
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body">
                ...
                <p class="text-muted mb-0">Available events, assignments, and uploads will appear here as the remaining MVP workflows are enabled.</p>
            </div>
        </div>
        ...
        <div class="row g-3 mb-4">
            <div class="col-6 col-md-3">
                <div class="card h-100"><div class="card-body"><p class="text-muted small mb-1">Gross sales</p><p class="h5 mb-0">{{ $salesSummary['grossSalesLabel'] }}</p></div></div>
            </div>
            <div class="col-6 col-md-3">
                <div class="card h-100"><div class="card-body"><p class="text-muted small mb-1">WivorPhotos commission</p><p class="h5 mb-0">{{ $salesSummary['commissionLabel'] }}</p></div></div>
            </div>
            <div class="col-6 col-md-3">
                <div class="card h-100"><div class="card-body"><p class="text-muted small mb-1">Payment-processing fees</p><p class="h5 mb-0">{{ $salesSummary['processingFeesLabel'] }}</p></div></div>
            </div>
            <div class="col-6 col-md-3">
                <div class="card h-100"><div class="card-body"><p class="text-muted small mb-1">Refunds</p><p class="h5 mb-0">{{ $salesSummary['refundsLabel'] }}</p></div></div>
            </div>
            <div class="col-6 col-md-4">
                <div class="card h-100"><div class="card-body"><p class="text-muted small mb-1">Net photographer earnings</p><p class="h5 mb-0">{{ $salesSummary['netEarningsLabel'] }}</p></div></div>
            </div>
            <div class="col-6 col-md-4">
                <div class="card h-100"><div class="card-body"><p class="text-muted small mb-1">Pending payout</p><p class="h5 mb-0">{{ $salesSummary['pendingPayoutLabel'] }}</p></div></div>
            </div>
            <div class="col-6 col-md-4">
                <div class="card h-100"><div class="card-body"><p class="text-muted small mb-1">Paid amount</p><p class="h5 mb-0">{{ $salesSummary['paidAmountLabel'] }}</p></div></div>
            </div>
        </div>
        ...
        <form class="card card-body mb-4" method="GET" action="{{ route('photographer.dashboard') }}">
            <div class="row g-3 align-items-end">
                <div class="col-sm-6 col-lg-2">
                    ...
                    <input class="form-control" id="date_from" name="date_from" type="date" value="{{ $salesFilters['date_from'] ?? '' }}">
                </div>
                <div class="col-sm-6 col-lg-2">
                    <label class="form-label" for="date_to">To</label>
                    <input class="form-control" id="date_to" name="date_to" type="date" value="{{ $salesFilters['date_to'] ?? '' }}">
                </div>
            ...
            <div class="table-responsive">
                <table class="table mb-0">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr><td colspan="9" class="text-muted text-center py-4">No sales match these filters.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
