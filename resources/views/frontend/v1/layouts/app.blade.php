<!-- resources/views/frontend/v1/layouts/app.blade.php -->
<!DOCTYPE html>
...
<head>
    ...
    @yield('styles')
    @include('frontend.v1.components.head-assets')
</head>

<body>
    @include('frontend.v1.components.header')
    <div>

        @yield('content')

    </div>
    @include('frontend.v1.components.footer')
    @yield('scripts')
</body>
