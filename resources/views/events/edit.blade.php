        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('events.update', $event->id) }}" accept-charset="UTF-8"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-4">
                                <input type="date" class="form-control flatpickr" id="published_at" name="published_at"
                                    value="{{ old('published_at', $event->published_at ? $event->published_at->format('Y-m-d') : '') }}">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                ...
                                @if (!empty($event->image_url))
                                    <div class="mt-2">
                                        <a href="{{ asset($event->image_url) }}" target="_blank">
                                        <i class="text-primary fas fa-eye font-size-20"></i>   <strong>View current image</strong></a>
                                        </a>
                                    </div>
                                @endif
                            </div>
